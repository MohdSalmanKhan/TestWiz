...
public class ImagePickerFactory implements FormWidgetFactory {
    ...
    public List<View> getViewsFromJson(String stepName, Context context, JSONObject jsonObject, com.example.android.wizardpager.wizard.Interfaces.CommonListener listener) throws Exception {
        ...
        imageView.setLayoutParams(getLayoutParams(MATCH_PARENT, dpToPixels(context, 200), 0, 0, 0, 16));
        ...
        uploadButton.setLayoutParams(getLayoutParams(WRAP_CONTENT, WRAP_CONTENT, 0, 0, 0, 16));
