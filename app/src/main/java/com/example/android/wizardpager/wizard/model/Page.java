...
public abstract class Page implements PageTreeNode {
    ...
    protected boolean mHasMiddleAction = false;
    ...
    public boolean hasMiddleAction() {
        return mHasMiddleAction;
    }
    ...
    public Page setHasMiddleAction(boolean hasAction) {
        mHasMiddleAction = hasAction;
        return this;
    }
}
