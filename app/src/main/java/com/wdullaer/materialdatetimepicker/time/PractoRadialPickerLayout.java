 ...
 */
public class PractoRadialPickerLayout extends FrameLayout implements View.OnTouchListener {
    ...
    public PractoRadialPickerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     * @param is24HourMode
     */
    public void initialize(Context context, PractoTimePickerDialog timePickerDialog,
    ...
    /**
     * Set update the AM/PM circle displays.
     *
     * @param amOrPm
     */
    public void updateAmPmView(int amOrPm) {
